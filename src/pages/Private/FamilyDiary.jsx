...
import fallfestival from "./images/fallfestival.png";
...
export default function FamilyDiary() {
    ...
    return (
        <div className="project-write-container">
            <div className="missionTop"> {/* mission-main-top */}
                <div className="mission_back_img" onClick={() => navigate('/MypageMain')}>  {/* mission-main-back-img */}
                    <img src={back} alt="" />
                </div>
